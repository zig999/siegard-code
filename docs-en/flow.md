...
|------|--------|---------------|
| `standard` | `/u-spec` novo, ou improve com mudança ampla | Pipeline completo: writer → reviewer → back → validator → front → validator → compliance. Exit exige `all_domains_validated`. |
