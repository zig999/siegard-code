# Backend Pipeline Skills

Skills used by agents in the backend Dev team.

## u-be-development

**Consumer**: Backend Developer

Coding patterns and conventions for backend implementation:
- Folder structure and naming conventions
- Route, controller, service, repository, and model patterns
