...
EMIT_SCRIPT = (
    Path(__file__).parent.parent / ".claude" / "skills" / "orch-report" / "scripts" / "emit.py"
)
APPEND_SCRIPT = (
    Path(__file__).parent.parent / ".claude" / "skills" / "orch-log" / "scripts" / "append.py"
)
READ_SCRIPT = (
    Path(__file__).parent.parent / ".claude" / "skills" / "orch-log" / "scripts" / "read.py"
)
