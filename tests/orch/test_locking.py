...
# TestLogLockConcurrency removed — concurrent-append seq integrity is a strict
# subset of test_append_hardening::test_concurrent_appends_stay_valid (which also
# verifies prev_hash chaining + per-event hash under threads).
