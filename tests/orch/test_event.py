...
class TestEventType:
    def test_total_count(self):
        assert len(EventType) == 35  # +handoff_receipt (08) +suite_run_started/completed (11) +orchestrator_resume_requested/resumed (E2) +cost_projected (R11a) +spec_baseline_recorded/handoff_manifest_generated (v2.35.0 PROV)
    ...
    def test_values_set(self):
        ...
        assert "spec_baseline_recorded" in values          # v2.35.0 PROV — adoption baseline
        assert "handoff_manifest_generated" in values      # v2.35.0 PROV — generator notarization
