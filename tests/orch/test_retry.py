...
# TestCircuitBreaker removed — evaluate_circuit_state is owned by the dedicated
# test_circuit_breaker.py (broader: window metadata, custom threshold, CLI). This
# class was off-topic for a retry-policy file and fully subsumed there.
