---
description: Guided questionnaire to capture bugs in a structured format. Generates bug##.md files in the dev session. Usage: /u-bug-report [SPECS_DIR] [SESSION] (e.g., /u-bug-report docs/specs fix-bugs-v2)
---

Read the following file:
1. .claude/skills/u-bug-report/SKILL.md
...
Follow the skill's question flow to collect bugs.
Ask one question at a time. After each bug, generate the `bug##.md` file in `{SESSIONS_DIR}/{SESSION}`.
